    ...
    <div>
      <div className="play-ground bg-gradient-to-r from-orange-500/80 to-red-700/80 backdrop-blur-md h-[700px] md:h-[700px] relative overflow-hidden md:w-[1000px] m-auto md:mt-10">
        ...
        <div className="absolute top-[300px] left-1/2  -translate-x-1/2 -translate-y-1/2 text-white text-left  text-xl md:text-2xl md:font-bold w-[350px] md:w-[800px]">
          ...
          <p>
            💡 You can write code that generates{" "}
            <span className="font-bold text-2xl md:text-3xl">outputs</span> with
            the{" "}
          ...
          <br />
          <h3 className=" text-2xl md:text-4xl text-black">
            What&apos;s next ⁉️
          </h3>
          <p>
            In the next lesson. You will create cod ewith multiple lines and
            different types of data.
          </p>
        </div>

        <Previous onPrevious={handlePrevious} />
        <CompletedBtn level="introduction to Java" />
