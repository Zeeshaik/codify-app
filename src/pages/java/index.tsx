...
export function JavaHomePage(props: IJavaHomePageProps) {
    ...
    <div className='bg-dark-layer-2 min-h-screen'>
      ...
      >
        ...
        <div className="flex-1 space-y-4 sm:text-center lg:text-left">
          ...
          <div className='mb-7 md:text-2xl sm:p-5 md:p-0' style={{
  fontFamily: 'ShadowIntoLight',
  fontWeight: 'bold',
  letterSpacing: '1px',
  color: 'white',
  ...
  <p className="hidden sm:block">public static void main(Strings[] args) {'{'}</p>
  ...
  <div className="sm:hidden">
    ...
    <p>{'}'}</p>
      ...
      <br />
      {/* Levels Section */}
      <h3 className="text-2xl sm:text-3xl md:text-2xl lg:text-5xl  font-bold text-center sm:text-left text-white md:ml-72 mb-10">
        Start Learning Java
      </h3>
      <Levels />
    </div>
